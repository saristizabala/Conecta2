    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http,
        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/v1/clients/{clientId}/offers/pending").hasRole("CLIENT")
                .requestMatchers("/api/v1/workers/{workerId}/offers/pending").hasRole("WORKER")
                .requestMatchers("/api/v1/offers/{id}/respond").hasRole("CLIENT")
